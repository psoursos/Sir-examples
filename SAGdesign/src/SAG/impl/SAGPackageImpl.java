...
public class SAGPackageImpl extends EPackageImpl implements SAGPackage {
	...
	public static SAGPackage init() {
		...
		Object registeredSAGPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SAGPackageImpl theSAGPackage = registeredSAGPackage instanceof SAGPackageImpl ? (SAGPackageImpl)registeredSAGPackage : new SAGPackageImpl();
