...
public class AIPPackageImpl extends EPackageImpl implements AIPPackage {
	...
	public static AIPPackage init() {
		...
		Object registeredAIPPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		AIPPackageImpl theAIPPackage = registeredAIPPackage instanceof AIPPackageImpl ? (AIPPackageImpl)registeredAIPPackage : new AIPPackageImpl();
