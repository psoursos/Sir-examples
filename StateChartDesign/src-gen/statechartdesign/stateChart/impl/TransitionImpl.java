 ...
 * </p>
 * <ul>
 *   <li>{@link statechartdesign.stateChart.impl.TransitionImpl#getTE <em>TE</em>}</li>
 *   <li>{@link statechartdesign.stateChart.impl.TransitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link statechartdesign.stateChart.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link statechartdesign.stateChart.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link statechartdesign.stateChart.impl.TransitionImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends MinimalEObjectImpl.Container implements Transition {
	...
	public Node getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StateChartPackage.TRANSITION__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(Node newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateChartPackage.TRANSITION__SOURCE, oldSource,
					source));
	}
	...
	public Node getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StateChartPackage.TRANSITION__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(Node newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateChartPackage.TRANSITION__TARGET, oldTarget,
					target));
	}
	...
	public void setMetadata(String newMetadata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateChartPackage.TRANSITION__METADATA, oldMetadata,
					metadata));
	}
